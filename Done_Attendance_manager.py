...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        bt1 = tk.Button(self, text="Start a new record", font=("Times", 16), height=2, width=17,
                        command=lambda: controller.show_frame(NewRecord))
        bt2 = tk.Button(self, text="Manage your attendance", font=("Times", 16), height=2, width=17,
                        command=lambda: controller.show_frame(ManageAttendance))
        bt3 = tk.Button(self, text="Delete your record", font=("Times", 16), height=2, width=17,
                        command=lambda: controller.show_frame(DeleteRecord))
        bt4 = tk.Button(self, text="Edit the record", font=("Times", 16), height=2, width=17,
...
class NewRecord(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label2 = tk.Label(self, text="if you want a new record, previous one will be deleted,continue?",
                          font=("Times", 12))

        bt2 = tk.Button(self, text="YES", font=("Times", 16), height=2, width=17,
                        command=lambda: controller.show_frame(AddSubjects))
        bt3 = tk.Button(self, text="NO", font=("Times", 16), height=2, width=17,
...
class ManageAttendance(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label1.pack()
        bt2 = tk.Button(self, text="show status", font=("Times", 16), height=2, width=17,
                        command=lambda: self.showstatus(controller))
        bt3 = tk.Button(self, text="Today's data", font=("Times", 16), height=2, width=17,
                        command=lambda: controller.show_frame(TodayData))
        bt1 = tk.Button(self, text="home", font=("Times", 16), height=2, width=17,
                        command=lambda: controller.show_frame(StartPage))
        bt2.pack()
        bt3.pack()
        bt1.pack()
...
class DeleteRecord(tk.Frame):
    def __init__(self, parent, controller):
        ...
        bt1 = tk.Button(self, text="NO", font=("Times", 16), height=2, width=17,
                        command=lambda: controller.show_frame(StartPage))
        label1.pack()
        label2.pack()
        bt2.pack()
...
class EditRecord(tk.Frame):
    def __init__(self, parent, controller):
        ...
        lb4.pack()
        txt3.pack()
        bt3 = tk.Button(self, text="Update", font=("Times", 16), height=2, width=17,
                        command=lambda: self.update(txt1.get(), txt2.get(), txt3.get()))
        bt2 = tk.Button(self, text="showid of subjects", font=("Times", 16), height=2, width=17,
...
class AddSubjects(tk.Frame):
    def __init__(self, parent, controller):
        ...
        bt2 = tk.Button(self, text="Add subjects!", font=("Times", 16), height=1, width=17,
...
class TodayData(tk.Frame):
    def __init__(self, parent, controller):
        ...
        lb4.pack()
        txt3.pack()
        bt3 = tk.Button(self, text="add to record", font=("Times", 16), height=2, width=17,
