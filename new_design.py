...
def popup():
    if CardValue != 0:
        ...
        #progressbar=customtkinter.CTkProgressBar(master=pop, width=740, height=20, border_width=3, fg_color="white", bg_color="black")
        #progressbar.place(x=20, y=360)
        print("popup start")
...
def mainWindow():
    ...
    label_middleTop= customtkinter.CTkLabel(master=mainwindow,bg_color=("gray90","gray16"), textvariable=var, text_font=('Helvetica',30,"bold"))
    ...
    button_in = customtkinter.CTkButton(master=mainwindow, command=arrivalToggle ,hover_color="#09bd6f",border_color="#0f0f0f", fg_color="#0dff96", image=open_image, text="Příchod", text_color="black", width=160, height=120, corner_radius=25,border_width=4,text_font=('Helvetica',17,'bold'),bg_color=("gray90","gray16"), compound="bottom")
    button_in.place(height='120', width='160', x=220, rely=0.2)

    button_out = customtkinter.CTkButton(master=mainwindow, command=leaveToggle, hover_color="#bf3d3d", border_color="#0f0f0f",fg_color="#ff5252", image=leave_image, text="Odchod", text_color="black",width=160, height=120, corner_radius=25,border_width=4,text_font=('Helvetica',17,'bold'),bg_color=("gray90","gray16"), compound="bottom")
    button_out.place(height='120', width='160', x=420, rely=0.2)

    button_doctor = customtkinter.CTkButton(master=mainwindow, command=doctorToggle,hover_color="#2d56ad",border_color="#0f0f0f",fg_color="#427bf5",image=doctor_image, text="Lékař", text_color="black", width=160, height=120, corner_radius=25,border_width=4,text_font=('Helvetica',17,'bold'),bg_color=("gray90","gray16"), compound="bottom")
    button_doctor.place(height='120', width='160', x=620, rely=0.2)
    ...
    ## Active label down for inform user about state
    label_down = customtkinter.CTkLabel(master=mainwindow,bg_color=("gray90","gray16"), text="Stiskněte tlačítko!",text_color="white", text_font=('Helvetica',20,"bold"))
    label_down.place(height='60', width='800',relx=0.0, rely=0.9)

    label_down_line = customtkinter.CTkLabel(master=mainwindow,bg_color="#34b7eb",text="")
    label_down_line.place(x='0', y='430',height='3', width='800')

    button_exit = customtkinter.CTkButton(master=mainwindow, command=close,fg_color="#ff0000",bg_color=("gray90","gray16"),text_color="black", text="x", width=20, height=20, corner_radius=10,border_width=3,text_font=('Helvetica',20))
    button_exit.place(height='40', width='40', relx=0.94, rely=0.91)
