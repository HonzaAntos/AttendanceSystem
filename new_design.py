...
button_in = customtkinter.CTkButton(master=root, command=arrivalToggle, image=open_image, text="Příchod", width=160, height=120, corner_radius=25,border_width=3,text_font=('Helvetica',17),bg_color="gray16", compound="bottom")
button_in.place(height='120', width='160', x=220, rely=0.2)
#button_in.grid(row=0,column=0,padx=20)
button_out = customtkinter.CTkButton(master=root, command=leaveToggle, image=leave_image, text="Odchod", width=160, height=120, corner_radius=25,border_width=3,text_font=('Helvetica',17),bg_color="gray16", compound="bottom")
button_out.place(height='120', width='160', x=420, rely=0.2)
#button_out.grid(row=0,column=1, padx=20)
button_doctor = customtkinter.CTkButton(master=root, command=doctorToggle,  image=doctor_image, text="Lékař", width=160, height=120, corner_radius=25,border_width=3,text_font=('Helvetica',17),bg_color="gray16", compound="bottom")
button_doctor.place(height='120', width='160', x=620, rely=0.2)
#button_doctor.grid(row=0,column=2, padx=20)
button_coffee = customtkinter.CTkButton(master=root, command=coffeeToggle ,image=coffee_image, text="Soukromě", width=160, height=120, corner_radius=25,border_width=3,text_font=('Helvetica',17),bg_color="gray16", compound="bottom")
